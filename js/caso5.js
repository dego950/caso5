		...
		methods: {
					...
					$.ajax({
						...
						success(result) {
							if (result) {
								...
								telemonitoreo.vacuna_nombre = telemonitoreo.infoVacuna[0].biologicoVacuna.nombreCorto;
			...
			sendData() {
				...
				data = {
					...
					"event_code":"346",
					"created_date":"04-11-2021 15:20:00",
					...
					"ocurrence_city_state":"33935_MEDELLIN - ANTIOQUIA",
					"ocurrence_state":"05",
					"ocurrence_city":"001",
